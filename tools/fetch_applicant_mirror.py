"""
Скачивает страницы раздела «Абитуриентам» с ngaek.by.
Запуск из корня: python tools/fetch_applicant_mirror.py
"""
...
from page.applicant_mirror_config import APPLICANT_SOURCE_PATHS as SOURCES  # noqa: E402

OUT_DIR = os.path.join(ROOT, "data", "applicants_mirror")
BASE = "https://ngaek.by"
...
def _fetch(url: str) -> str:
    ...
    req = urllib.request.Request(
        url,
        headers={"User-Agent": "NgaekMirrorFetcher/1.0 (+applicants section)"},
    )
